...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;var toc_default=`button#toc {
  background-color: transparent;
  border: none;
  text-align: left;
  cursor: pointer;
...
<rss version="2.0">
    <channel>
      ...
      ${items}
            ...
            `,slug,ext:".html"});fps.push(fp)}}return fps}}),"AliasRedirects");import path11 from"path";import fs3 from"fs";import path10 from"path";import{globby}from"globby";function toPosixPath(fp){return fp.split(path10.sep).join("/")}__name(toPosixPath,"toPosixPath");async function glob(pattern,cwd,ignorePatterns){return(await globby(pattern,{cwd,ignore:ignorePatterns,gitignore:!0})).map(toPosixPath)}__name(glob,"glob");var filesToCopy=__name(async(argv,cfg)=>await glob("**",argv.directory,["**/*.md",...cfg.configuration.ignorePatterns]),"filesToCopy"),Assets=__name(()=>({name:"Assets",getQuartzComponents(){return[]},async getDependencyGraph(ctx,_content,_resources){let{argv,cfg}=ctx,graph=new DepGraph,fps=await filesToCopy(argv,cfg);for(let fp of fps){let ext=path11.extname(fp),src=joinSegments(argv.directory,fp),name=slugifyFilePath(fp,!0)+ext,dest=joinSegments(argv.output,name);graph.addEdge(src,dest)}return graph},async emit({argv,cfg},_content,_resources){let assetsPath=argv.output,fps=await filesToCopy(argv,cfg),res=[];for(let fp of fps){let ext=path11.extname(fp),src=joinSegments(argv.directory,fp),name=slugifyFilePath(fp,!0)+ext,dest=joinSegments(assetsPath,name),dir=path11.dirname(dest);await fs3.promises.mkdir(dir,{recursive:!0}),await fs3.promises.copyFile(src,dest),res.push(dest)}return res}}),"Assets");import fs4 from"fs";var Static=__name(()=>({name:"Static",getQuartzComponents(){return[]},async getDependencyGraph({argv,cfg},_content,_resources){let graph=new DepGraph,staticPath=joinSegments(QUARTZ,"static"),fps=await glob("**",staticPath,cfg.configuration.ignorePatterns);for(let fp of fps)graph.addEdge(joinSegments("static",fp),joinSegments(argv.output,"static",fp));return graph},async emit({argv,cfg},_content,_resources){let staticPath=joinSegments(QUARTZ,"static"),fps=await glob("**",staticPath,cfg.configuration.ignorePatterns);return await fs4.promises.cp(staticPath,joinSegments(argv.output,"static"),{recursive:!0,dereference:!0}),fps.map(fp=>joinSegments(argv.output,"static",fp))}}),"Static");var spa_inline_default='var O=Object.create;var b=Object.defineProperty;var $=Object.getOwnPropertyDescriptor;var W=Object.getOwnPropertyNames;var I=Object.getPrototypeOf,V=Object.prototype.hasOwnProperty;var _=(u,e)=>()=>(e||u((e={exports:{}}).exports,e),e.exports);var H=(u,e,D,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let F of W(e))!V.call(u,F)&&F!==D&&b(u,F,{get:()=>e[F],enumerable:!(r=$(e,F))||r.enumerable});return u};var q=(u,e,D)=>(D=u!=null?O(I(u)):{},H(e||!u||!u.__esModule?b(D,"default",{value:u,enumerable:!0}):D,u));var T=_((Eu,L)=>{"use strict";L.exports=J;function f(u){return u instanceof Buffer?Buffer.from(u):new u.constructor(u.buffer.slice(),u.byteOffset,u.length)}function J(u){if(u=u||{},u.circles)return X(u);return u.proto?r:D;function e(F,i){for(var t=Object.keys(F),n=new Array(t.length),a=0;a<t.length;a++){var l=t[a],o=F[l];typeof o!="object"||o===null?n[l]=o:o instanceof Date?n[l]=new Date(o):ArrayBuffer.isView(o)?n[l]=f(o):n[l]=i(o)}return n}function D(F){if(typeof F!="object"||F===null)return F;if(F instanceof Date)return new Date(F);if(Array.isArray(F))return e(F,D);if(F instanceof Map)return new Map(e(Array.from(F),D));if(F instanceof Set)return new Set(e(Array.from(F),D));var i={};for(var t in F)if(Object.hasOwnProperty.call(F,t)!==!1){var n=F[t];typeof n!="object"||n===null?i[t]=n:n instanceof Date?i[t]=new Date(n):n instanceof Map?i[t]=new Map(e(Array.from(n),D)):n instanceof Set?i[t]=new Set(e(Array.from(n),D)):ArrayBuffer.isView(n)?i[t]=f(n):i[t]=D(n)}return i}function r(F){if(typeof F!="object"||F===null)return F;if(F instanceof Date)return new Date(F);if(Array.isArray(F))return e(F,r);if(F instanceof Map)return new Map(e(Array.from(F),r));if(F instanceof Set)return new Set(e(Array.from(F),r));var i={};for(var t in F){var n=F[t];typeof n!="object"||n===null?i[t]=n:n instanceof Date?i[t]=new Date(n):n instanceof Map?i[t]=new Map(e(Array.from(n),r)):n instanceof Set?i[t]=new Set(e(Array.from(n),r)):ArrayBuffer.isView(n)?i[t]=f(n):i[t]=r(n)}return i}}function X(u){var e=[],D=[];return u.proto?i:F;function r(t,n){for(var a=Object.keys(t),l=new Array(a.length),o=0;o<a.length;o++){var A=a[o],s=t[A];if(typeof s!="object"||s===null)l[A]=s;else if(s instanceof Date)l[A]=new Date(s);else if(ArrayBuffer.isView(s))l[A]=f(s);else{var S=e.indexOf(s);S!==-1?l[A]=D[S]:l[A]=n(s)}}return l}function F(t){if(typeof t!="object"||t===null)return t;if(t instanceof Date)return new Date(t);if(Array.isArray(t))return r(t,F);if(t instanceof Map)return new Map(r(Array.from(t),F));if(t instanceof Set)return new Set(r(Array.from(t),F));var n={};e.push(t),D.push(n);for(var a in t)if(Object.hasOwnProperty.call(t,a)!==!1){var l=t[a];if(typeof l!="object"||l===null)n[a]=l;else if(l instanceof Date)n[a]=new Date(l);else if(l instanceof Map)n[a]=new Map(r(Array.from(l),F));else if(l instanceof Set)n[a]=new Set(r(Array.from(l),F));else if(ArrayBuffer.isView(l))n[a]=f(l);else{var o=e.indexOf(l);o!==-1?n[a]=D[o]:n[a]=F(l)}}return e.pop(),D.pop(),n}function i(t){if(typeof t!="object"||t===null)return t;if(t instanceof Date)return new Date(t);if(Array.isArray(t))return r(t,i);if(t instanceof Map)return new Map(r(Array.from(t),i));if(t instanceof Set)return new Set(r(Array.from(t),i));var n={};e.push(t),D.push(n);for(var a in t){var l=t[a];if(typeof l!="object"||l===null)n[a]=l;else if(l instanceof Date)n[a]=new Date(l);else if(l instanceof Map)n[a]=new Map(r(Array.from(l),i));else if(l instanceof Set)n[a]=new Set(r(Array.from(l),i));else if(ArrayBuffer.isView(l))n[a]=f(l);else{var o=e.indexOf(l);o!==-1?n[a]=D[o]:n[a]=i(l)}}return e.pop(),D.pop(),n}}});var g=u=>(e,D)=>e[`node${u}`]===D[`node${u}`],z=g("Name"),K=g("Type"),Z=g("Value");function x(u,e){if(u.attributes.length===0&&e.attributes.length===0)return[];let D=[],r=new Map,F=new Map;for(let i of u.attributes)r.set(i.name,i.value);for(let i of e.attributes){let t=r.get(i.name);i.value===t?r.delete(i.name):(typeof t<"u"&&r.delete(i.name),F.set(i.name,i.value))}for(let i of r.keys())D.push({type:5,name:i});for(let[i,t]of F.entries())D.push({type:4,name:i,value:t});return D}function d(u,e=!0){let D=`${u.localName}`;for(let{name:r,value:F}of u.attributes)e&&r.startsWith("data-")||(D+=`[${r}=${F}]`);return D+=u.innerHTML,D}function p(u){switch(u.tagName){case"BASE":case"TITLE":return u.localName;case"META":{if(u.hasAttribute("name"))return`meta[name="${u.getAttribute("name")}"]`;if(u.hasAttribute("property"))return`meta[name="${u.getAttribute("property")}"]`;break}case"LINK":{if(u.hasAttribute("rel")&&u.hasAttribute("href"))return`link[rel="${u.getAttribute("rel")}"][href="${u.getAttribute("href")}"]`;if(u.hasAttribute("href"))return`link[href="${u.getAttribute("href")}"]`;break}}return d(u)}function Q(u){let[e,D=""]=u.split("?");return`${e}?t=${Date.now()}&${D.replace(/t=\\d+/g,"")}`}function E(u){if(u.nodeType===1&&u.hasAttribute("data-persist"))return u;if(u.nodeType===1&&u.localName==="script"){let e=document.createElement("script");for(let{name:D,value:r}of u.attributes)D==="src"&&(r=Q(r)),e.setAttribute(D,r);return e.innerHTML=u.innerHTML,e}return u.cloneNode(!0)}function Y(u,e){if(u.children.length===0&&e.children.length===0)return[];let D=[],r=new Map,F=new Map,i=new Map;for(let t of u.children)r.set(p(t),t);for(let t of e.children){let n=p(t),a=r.get(n);a?d(t,!1)!==d(a,!1)&&F.set(n,E(t)):i.set(n,E(t)),r.delete(n)}for(let t of u.childNodes){if(t.nodeType===1){let n=p(t);if(r.has(n)){D.push({type:1});continue}else if(F.has(n)){let a=F.get(n);D.push({type:3,attributes:x(t,a),children:R(t,a)});continue}}D.push(void 0)}for(let t of i.values())D.push({type:0,node:E(t)});return D}function R(u,e){let D=[],r=Math.max(u.childNodes.length,e.childNodes.length);for(let F=0;F<r;F++){let i=u.childNodes.item(F),t=e.childNodes.item(F);D[F]=c(i,t)}return D}function c(u,e){if(!u)return{type:0,node:E(e)};if(!e)return{type:1};if(K(u,e)){if(u.nodeType===3){let D=u.nodeValue,r=e.nodeValue;if(D.trim().length===0&&r.trim().length===0)return}if(u.nodeType===1){if(z(u,e)){let D=u.tagName==="HEAD"?Y:R;return{type:3,attributes:x(u,e),children:D(u,e)}}return{type:2,node:E(e)}}else return u.nodeType===9?c(u.documentElement,e.documentElement):Z(u,e)?void 0:{type:2,value:e.nodeValue}}return{type:2,node:E(e)}}function G(u,e){if(e.length!==0)for(let{type:D,name:r,value:F}of e)D===5?u.removeAttribute(r):D===4&&u.setAttribute(r,F)}async function h(u,e,D){if(!e)return;let r;switch(u.nodeType===9?(u=u.documentElement,r=u):D?r=D:r=u,e.type){case 0:{let{node:F}=e;u.appendChild(F);return}case 1:{if(!r)return;u.removeChild(r);return}case 2:{if(!r)return;let{node:F,value:i}=e;if(typeof i=="string"){r.nodeValue=i;return}r.replaceWith(F);return}case 3:{if(!r)return;let{attributes:F,children:i}=e;G(r,F);let t=Array.from(r.childNodes);await Promise.all(i.map((n,a)=>h(r,n,t[a])));return}}}function m(u,e){let D=c(u,e);return h(u,D)}var su=Object.hasOwnProperty;var U=q(T(),1),cu=(0,U.default)();function y(u){return u.document.body.dataset.slug}var M=(u,e,D)=>{let r=new URL(u.getAttribute(e),D);u.setAttribute(e,r.pathname+r.hash)};function j(u,e){u.querySelectorAll(\'[href^="./"], [href^="../"]\').forEach(D=>M(D,"href",e)),u.querySelectorAll(\'[src^="./"], [src^="../"]\').forEach(D=>M(D,"src",e))}var k=1,C=document.createElement("route-announcer"),uu=u=>u?.nodeType===k,eu=u=>{try{let e=new URL(u);if(window.location.origin===e.origin)return!0}catch{}return!1},tu=u=>{let e=u.origin===window.location.origin,D=u.pathname===window.location.pathname;return e&&D},N=({target:u})=>{if(!uu(u)||u.attributes.getNamedItem("target")?.value==="_blank")return;let e=u.closest("a");if(!e||"routerIgnore"in e.dataset)return;let{href:D}=e;if(eu(D))return{url:new URL(D),scroll:"routerNoscroll"in e.dataset?!1:void 0}};function P(u){let e=new CustomEvent("nav",{detail:{url:u}});document.dispatchEvent(e)}var v=new Set;window.addCleanup=u=>v.add(u);var w;async function B(u,e=!1){w=w||new DOMParser;let D=await fetch(`${u}`).then(n=>{if(n.headers.get("content-type")?.startsWith("text/html"))return n.text();window.location.assign(u)}).catch(()=>{window.location.assign(u)});if(!D)return;v.forEach(n=>n()),v.clear();let r=w.parseFromString(D,"text/html");j(r,u);let F=r.querySelector("title")?.textContent;if(F)document.title=F;else{let n=document.querySelector("h1");F=n?.innerText??n?.textContent??u.pathname}C.textContent!==F&&(C.textContent=F),C.dataset.persist="",r.body.appendChild(C),m(document.body,r.body),e||(u.hash?document.getElementById(decodeURIComponent(u.hash.substring(1)))?.scrollIntoView():window.scrollTo({top:0})),document.head.querySelectorAll(":not([spa-preserve])").forEach(n=>n.remove()),r.head.querySelectorAll(":not([spa-preserve])").forEach(n=>document.head.appendChild(n)),e||history.pushState({},"",u),P(y(window)),delete C.dataset.persist}window.spaNavigate=B;function Du(){return typeof window<"u"&&(window.addEventListener("click",async u=>{let{url:e}=N(u)??{};if(!(!e||u.ctrlKey||u.metaKey)){if(u.preventDefault(),tu(e)&&e.hash){document.getElementById(decodeURIComponent(e.hash.substring(1)))?.scrollIntoView(),history.pushState({},"",e);return}try{B(e,!1)}catch{window.location.assign(e)}}}),window.addEventListener("popstate",u=>{let{url:e}=N(u)??{};if(!(window.location.hash&&window.location.pathname===e?.pathname))try{B(new URL(window.location.toString()),!0)}catch{window.location.reload()}})),new class{go(e){let D=new URL(e,window.location.toString());return B(D,!1)}back(){return window.history.back()}forward(){return window.history.forward()}}}Du();P(y(window));if(!customElements.get("route-announcer")){let u={"aria-live":"assertive","aria-atomic":"true",style:"position: absolute; left: 0; top: 0; clip: rect(0 0 0 0); clip-path: inset(50%); overflow: hidden; white-space: nowrap; width: 1px; height: 1px"};customElements.define("route-announcer",class extends HTMLElement{constructor(){super()}connectedCallback(){for(let[D,r]of Object.entries(u))this.setAttribute(D,r)}})}\n';var popover_inline_default='var qt=Object.create;var dt=Object.defineProperty;var Kt=Object.getOwnPropertyDescriptor;var Zt=Object.getOwnPropertyNames;var Qt=Object.getPrototypeOf,Gt=Object.prototype.hasOwnProperty;var Jt=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports);var te=(t,e,u,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Zt(e))!Gt.call(t,i)&&i!==u&&dt(t,i,{get:()=>e[i],enumerable:!(n=Kt(e,i))||n.enumerable});return t};var ee=(t,e,u)=>(u=t!=null?qt(Qt(t)):{},te(e||!t||!t.__esModule?dt(u,"default",{value:t,enumerable:!0}):u,t));var zt=Jt((Ke,_t)=>{"use strict";_t.exports=Be;function X(t){return t instanceof Buffer?Buffer.from(t):new t.constructor(t.buffer.slice(),t.byteOffset,t.length)}function Be(t){if(t=t||{},t.circles)return xe(t);return t.proto?n:u;function e(i,r){for(var o=Object.keys(i),s=new Array(o.length),c=0;c<o.length;c++){var l=o[c],D=i[l];typeof D!="object"||D===null?s[l]=D:D instanceof Date?s[l]=new Date(D):ArrayBuffer.isView(D)?s[l]=X(D):s[l]=r(D)}return s}function u(i){if(typeof i!="object"||i===null)return i;if(i instanceof Date)return new Date(i);if(Array.isArray(i))return e(i,u);if(i instanceof Map)return new Map(e(Array.from(i),u));if(i instanceof Set)return new Set(e(Array.from(i),u));var r={};for(var o in i)if(Object.hasOwnProperty.call(i,o)!==!1){var s=i[o];typeof s!="object"||s===null?r[o]=s:s instanceof Date?r[o]=new Date(s):s instanceof Map?r[o]=new Map(e(Array.from(s),u)):s instanceof Set?r[o]=new Set(e(Array.from(s),u)):ArrayBuffer.isView(s)?r[o]=X(s):r[o]=u(s)}return r}function n(i){if(typeof i!="object"||i===null)return i;if(i instanceof Date)return new Date(i);if(Array.isArray(i))return e(i,n);if(i instanceof Map)return new Map(e(Array.from(i),n));if(i instanceof Set)return new Set(e(Array.from(i),n));var r={};for(var o in i){var s=i[o];typeof s!="object"||s===null?r[o]=s:s instanceof Date?r[o]=new Date(s):s instanceof Map?r[o]=new Map(e(Array.from(s),n)):s instanceof Set?r[o]=new Set(e(Array.from(s),n)):ArrayBuffer.isView(s)?r[o]=X(s):r[o]=n(s)}return r}}function xe(t){var e=[],u=[];return t.proto?r:i;function n(o,s){for(var c=Object.keys(o),l=new Array(c.length),D=0;D<c.length;D++){var a=c[D],F=o[a];if(typeof F!="object"||F===null)l[a]=F;else if(F instanceof Date)l[a]=new Date(F);else if(ArrayBuffer.isView(F))l[a]=X(F);else{var f=e.indexOf(F);f!==-1?l[a]=u[f]:l[a]=s(F)}}return l}function i(o){if(typeof o!="object"||o===null)return o;if(o instanceof Date)return new Date(o);if(Array.isArray(o))return n(o,i);if(o instanceof Map)return new Map(n(Array.from(o),i));if(o instanceof Set)return new Set(n(Array.from(o),i));var s={};e.push(o),u.push(s);for(var c in o)if(Object.hasOwnProperty.call(o,c)!==!1){var l=o[c];if(typeof l!="object"||l===null)s[c]=l;else if(l instanceof Date)s[c]=new Date(l);else if(l instanceof Map)s[c]=new Map(n(Array.from(l),i));else if(l instanceof Set)s[c]=new Set(n(Array.from(l),i));else if(ArrayBuffer.isView(l))s[c]=X(l);else{var D=e.indexOf(l);D!==-1?s[c]=u[D]:s[c]=i(l)}}return e.pop(),u.pop(),s}function r(o){if(typeof o!="object"||o===null)return o;if(o instanceof Date)return new Date(o);if(Array.isArray(o))return n(o,r);if(o instanceof Map)return new Map(n(Array.from(o),r));if(o instanceof Set)return new Set(n(Array.from(o),r));var s={};e.push(o),u.push(s);for(var c in o){var l=o[c];if(typeof l!="object"||l===null)s[c]=l;else if(l instanceof Date)s[c]=new Date(l);else if(l instanceof Map)s[c]=new Map(n(Array.from(l),r));else if(l instanceof Set)s[c]=new Set(n(Array.from(l),r));else if(ArrayBuffer.isView(l))s[c]=X(l);else{var D=e.indexOf(l);D!==-1?s[c]=u[D]:s[c]=r(l)}}return e.pop(),u.pop(),s}}});var j=Math.min,y=Math.max,K=Math.round;var L=t=>({x:t,y:t}),ne={left:"right",right:"left",bottom:"top",top:"bottom"},ue={start:"end",end:"start"};function lt(t,e,u){return y(t,j(e,u))}function Z(t,e){return typeof t=="function"?t(e):t}function T(t){return t.split("-")[0]}function ut(t){return t.split("-")[1]}function ct(t){return t==="x"?"y":"x"}function Dt(t){return t==="y"?"height":"width"}function Q(t){return["top","bottom"].includes(T(t))?"y":"x"}function at(t){return ct(Q(t))}function mt(t,e,u){u===void 0&&(u=!1);let n=ut(t),i=at(t),r=Dt(i),o=i==="x"?n===(u?"end":"start")?"right":"left":n==="start"?"bottom":"top";return e.reference[r]>e.floating[r]&&(o=q(o)),[o,q(o)]}function gt(t){let e=q(t);return[nt(t),e,nt(e)]}function nt(t){return t.replace(/start|end/g,e=>ue[e])}function ie(t,e,u){let n=["left","right"],i=["right","left"],r=["top","bottom"],o=["bottom","top"];switch(t){case"top":case"bottom":return u?e?i:n:e?n:i;case"left":case"right":return e?r:o;default:return[]}}function At(t,e,u,n){let i=ut(t),r=ie(T(t),u==="start",n);return i&&(r=r.map(o=>o+"-"+i),e&&(r=r.concat(r.map(nt)))),r}function q(t){return t.replace(/left|right|bottom|top/g,e=>ne[e])}function oe(t){return{top:0,right:0,bottom:0,left:0,...t}}function ft(t){return typeof t!="number"?oe(t):{top:t,right:t,bottom:t,left:t}}function P(t){let{x:e,y:u,width:n,height:i}=t;return{width:n,height:i,top:u,left:e,right:e+n,bottom:u+i,x:e,y:u}}function pt(t,e,u){let{reference:n,floating:i}=t,r=Q(e),o=at(e),s=Dt(o),c=T(e),l=r==="y",D=n.x+n.width/2-i.width/2,a=n.y+n.height/2-i.height/2,F=n[s]/2-i[s]/2,f;switch(c){case"top":f={x:D,y:n.y-i.height};break;case"bottom":f={x:D,y:n.y+n.height};break;case"right":f={x:n.x+n.width,y:a};break;case"left":f={x:n.x-i.width,y:a};break;default:f={x:n.x,y:n.y}}switch(ut(e)){case"start":f[o]-=F*(u&&l?-1:1);break;case"end":f[o]+=F*(u&&l?-1:1);break}return f}var Et=async(t,e,u)=>{let{placement:n="bottom",strategy:i="absolute",middleware:r=[],platform:o}=u,s=r.filter(Boolean),c=await(o.isRTL==null?void 0:o.isRTL(e)),l=await o.getElementRects({reference:t,floating:e,strategy:i}),{x:D,y:a}=pt(l,n,c),F=n,f={},d=0;for(let g=0;g<s.length;g++){let{name:m,fn:p}=s[g],{x:A,y:E,data:C,reset:h}=await p({x:D,y:a,initialPlacement:n,placement:F,strategy:i,middlewareData:f,rects:l,platform:o,elements:{reference:t,floating:e}});D=A??D,a=E??a,f={...f,[m]:{...f[m],...C}},h&&d<=50&&(d++,typeof h=="object"&&(h.placement&&(F=h.placement),h.rects&&(l=h.rects===!0?await o.getElementRects({reference:t,floating:e,strategy:i}):h.rects),{x:D,y:a}=pt(l,F,c)),g=-1)}return{x:D,y:a,placement:F,strategy:i,middlewareData:f}};async function Ft(t,e){var u;e===void 0&&(e={});let{x:n,y:i,platform:r,rects:o,elements:s,strategy:c}=t,{boundary:l="clippingAncestors",rootBoundary:D="viewport",elementContext:a="floating",altBoundary:F=!1,padding:f=0}=Z(e,t),d=ft(f),m=s[F?a==="floating"?"reference":"floating":a],p=P(await r.getClippingRect({element:(u=await(r.isElement==null?void 0:r.isElement(m)))==null||u?m:m.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(s.floating)),boundary:l,rootBoundary:D,strategy:c})),A=a==="floating"?{x:n,y:i,width:o.floating.width,height:o.floating.height}:o.reference,E=await(r.getOffsetParent==null?void 0:r.getOffsetParent(s.floating)),C=await(r.isElement==null?void 0:r.isElement(E))?await(r.getScale==null?void 0:r.getScale(E))||{x:1,y:1}:{x:1,y:1},h=P(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:s,rect:A,offsetParent:E,strategy:c}):A);return{top:(p.top-h.top+d.top)/C.y,bottom:(h.bottom-p.bottom+d.bottom)/C.y,left:(p.left-h.left+d.left)/C.x,right:(h.right-p.right+d.right)/C.x}}var ht=function(t){return t===void 0&&(t={}),{name:"flip",options:t,async fn(e){var u,n;let{placement:i,middlewareData:r,rects:o,initialPlacement:s,platform:c,elements:l}=e,{mainAxis:D=!0,crossAxis:a=!0,fallbackPlacements:F,fallbackStrategy:f="bestFit",fallbackAxisSideDirection:d="none",flipAlignment:g=!0,...m}=Z(t,e);if((u=r.arrow)!=null&&u.alignmentOffset)return{};let p=T(i),A=T(s)===s,E=await(c.isRTL==null?void 0:c.isRTL(l.floating)),C=F||(A||!g?[q(s)]:gt(s));!F&&d!=="none"&&C.push(...At(s,g,d,E));let h=[s,...C],N=await Ft(e,m),$=[],U=((n=r.flip)==null?void 0:n.overflows)||[];if(D&&$.push(N[p]),a){let b=mt(i,o,E);$.push(N[b[0]],N[b[1]])}if(U=[...U,{placement:i,overflows:$}],!$.every(b=>b<=0)){var et,x;let b=(((et=r.flip)==null?void 0:et.index)||0)+1,I=h[b];if(I)return{data:{index:b,overflows:U},reset:{placement:I}};let H=(x=U.filter(S=>S.overflows[0]<=0).sort((S,O)=>S.overflows[1]-O.overflows[1])[0])==null?void 0:x.placement;if(!H)switch(f){case"bestFit":{var z;let S=(z=U.map(O=>[O.placement,O.overflows.filter(V=>V>0).reduce((V,st)=>V+st,0)]).sort((O,V)=>O[1]-V[1])[0])==null?void 0:z[0];S&&(H=S);break}case"initialPlacement":H=s;break}if(i!==H)return{reset:{placement:H}}}return{}}}};function Ct(t){let e=j(...t.map(r=>r.left)),u=j(...t.map(r=>r.top)),n=y(...t.map(r=>r.right)),i=y(...t.map(r=>r.bottom));return{x:e,y:u,width:n-e,height:i-u}}function re(t){let e=t.slice().sort((i,r)=>i.y-r.y),u=[],n=null;for(let i=0;i<e.length;i++){let r=e[i];!n||r.y-n.y>n.height/2?u.push([r]):u[u.length-1].push(r),n=r}return u.map(i=>P(Ct(i)))}var Bt=function(t){return t===void 0&&(t={}),{name:"inline",options:t,async fn(e){let{placement:u,elements:n,rects:i,platform:r,strategy:o}=e,{padding:s=2,x:c,y:l}=Z(t,e),D=Array.from(await(r.getClientRects==null?void 0:r.getClientRects(n.reference))||[]),a=re(D),F=P(Ct(D)),f=ft(s);function d(){if(a.length===2&&a[0].left>a[1].right&&c!=null&&l!=null)return a.find(m=>c>m.left-f.left&&c<m.right+f.right&&l>m.top-f.top&&l<m.bottom+f.bottom)||F;if(a.length>=2){if(Q(u)==="y"){let x=a[0],z=a[a.length-1],b=T(u)==="top",I=x.top,H=z.bottom,S=b?x.left:z.left,O=b?x.right:z.right,V=O-S,st=H-I;return{top:I,bottom:H,left:S,right:O,width:V,height:st,x:S,y:I}}let m=T(u)==="left",p=y(...a.map(x=>x.right)),A=j(...a.map(x=>x.left)),E=a.filter(x=>m?x.left===A:x.right===p),C=E[0].top,h=E[E.length-1].bottom,N=A,$=p,U=$-N,et=h-C;return{top:C,bottom:h,left:N,right:$,width:U,height:et,x:N,y:C}}return F}let g=await r.getElementRects({reference:{getBoundingClientRect:d},floating:n.floating,strategy:o});return i.reference.x!==g.reference.x||i.reference.y!==g.reference.y||i.reference.width!==g.reference.width||i.reference.height!==g.reference.height?{reset:{rects:g}}:{}}}};var xt=function(t){return t===void 0&&(t={}),{name:"shift",options:t,async fn(e){let{x:u,y:n,placement:i}=e,{mainAxis:r=!0,crossAxis:o=!1,limiter:s={fn:m=>{let{x:p,y:A}=m;return{x:p,y:A}}},...c}=Z(t,e),l={x:u,y:n},D=await Ft(e,c),a=Q(T(i)),F=ct(a),f=l[F],d=l[a];if(r){let m=F==="y"?"top":"left",p=F==="y"?"bottom":"right",A=f+D[m],E=f-D[p];f=lt(A,f,E)}if(o){let m=a==="y"?"top":"left",p=a==="y"?"bottom":"right",A=d+D[m],E=d-D[p];d=lt(A,d,E)}let g=s.fn({...e,[F]:f,[a]:d});return{...g,data:{x:g.x-u,y:g.y-n}}}}};function M(t){return yt(t)?(t.nodeName||"").toLowerCase():"#document"}function B(t){var e;return(t==null||(e=t.ownerDocument)==null?void 0:e.defaultView)||window}function W(t){var e;return(e=(yt(t)?t.ownerDocument:t.document)||window.document)==null?void 0:e.documentElement}function yt(t){return t instanceof Node||t instanceof B(t).Node}function R(t){return t instanceof Element||t instanceof B(t).Element}function v(t){return t instanceof HTMLElement||t instanceof B(t).HTMLElement}function wt(t){return typeof ShadowRoot>"u"?!1:t instanceof ShadowRoot||t instanceof B(t).ShadowRoot}function k(t){let{overflow:e,overflowX:u,overflowY:n,display:i}=w(t);return/auto|scroll|overlay|hidden|clip/.test(e+n+u)&&!["inline","contents"].includes(i)}function vt(t){return["table","td","th"].includes(M(t))}function ot(t){let e=rt(),u=w(t);return u.transform!=="none"||u.perspective!=="none"||(u.containerType?u.containerType!=="normal":!1)||!e&&(u.backdropFilter?u.backdropFilter!=="none":!1)||!e&&(u.filter?u.filter!=="none":!1)||["transform","perspective","filter"].some(n=>(u.willChange||"").includes(n))||["paint","layout","strict","content"].some(n=>(u.contain||"").includes(n))}function bt(t){let e=_(t);for(;v(e)&&!G(e);){if(ot(e))return e;e=_(e)}return null}function rt(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}function G(t){return["html","body","#document"].includes(M(t))}function w(t){return B(t).getComputedStyle(t)}function J(t){return R(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.pageXOffset,scrollTop:t.pageYOffset}}function _(t){if(M(t)==="html")return t;let e=t.assignedSlot||t.parentNode||wt(t)&&t.host||W(t);return wt(e)?e.host:e}function St(t){let e=_(t);return G(e)?t.ownerDocument?t.ownerDocument.body:t.body:v(e)&&k(e)?e:St(e)}function it(t,e,u){var n;e===void 0&&(e=[]),u===void 0&&(u=!0);let i=St(t),r=i===((n=t.ownerDocument)==null?void 0:n.body),o=B(i);return r?e.concat(o,o.visualViewport||[],k(i)?i:[],o.frameElement&&u?it(o.frameElement):[]):e.concat(i,it(i,[],u))}function Lt(t){let e=w(t),u=parseFloat(e.width)||0,n=parseFloat(e.height)||0,i=v(t),r=i?t.offsetWidth:u,o=i?t.offsetHeight:n,s=K(u)!==r||K(n)!==o;return s&&(u=r,n=o),{width:u,height:n,$:s}}function Tt(t){return R(t)?t:t.contextElement}function Y(t){let e=Tt(t);if(!v(e))return L(1);let u=e.getBoundingClientRect(),{width:n,height:i,$:r}=Lt(e),o=(r?K(u.width):u.width)/n,s=(r?K(u.height):u.height)/i;return(!o||!Number.isFinite(o))&&(o=1),(!s||!Number.isFinite(s))&&(s=1),{x:o,y:s}}var se=L(0);function Pt(t){let e=B(t);return!rt()||!e.visualViewport?se:{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}}function le(t,e,u){return e===void 0&&(e=!1),!u||e&&u!==B(t)?!1:e}function tt(t,e,u,n){e===void 0&&(e=!1),u===void 0&&(u=!1);let i=t.getBoundingClientRect(),r=Tt(t),o=L(1);e&&(n?R(n)&&(o=Y(n)):o=Y(t));let s=le(r,u,n)?Pt(r):L(0),c=(i.left+s.x)/o.x,l=(i.top+s.y)/o.y,D=i.width/o.x,a=i.height/o.y;if(r){let F=B(r),f=n&&R(n)?B(n):n,d=F,g=d.frameElement;for(;g&&n&&f!==d;){let m=Y(g),p=g.getBoundingClientRect(),A=w(g),E=p.left+(g.clientLeft+parseFloat(A.paddingLeft))*m.x,C=p.top+(g.clientTop+parseFloat(A.paddingTop))*m.y;c*=m.x,l*=m.y,D*=m.x,a*=m.y,c+=E,l+=C,d=B(g),g=d.frameElement}}return P({width:D,height:a,x:c,y:l})}var ce=[":popover-open",":modal"];function Mt(t){return ce.some(e=>{try{return t.matches(e)}catch{return!1}})}function De(t){let{elements:e,rect:u,offsetParent:n,strategy:i}=t,r=i==="fixed",o=W(n),s=e?Mt(e.floating):!1;if(n===o||s&&r)return u;let c={scrollLeft:0,scrollTop:0},l=L(1),D=L(0),a=v(n);if((a||!a&&!r)&&((M(n)!=="body"||k(o))&&(c=J(n)),v(n))){let F=tt(n);l=Y(n),D.x=F.x+n.clientLeft,D.y=F.y+n.clientTop}return{width:u.width*l.x,height:u.height*l.y,x:u.x*l.x-c.scrollLeft*l.x+D.x,y:u.y*l.y-c.scrollTop*l.y+D.y}}function ae(t){return Array.from(t.getClientRects())}function Wt(t){return tt(W(t)).left+J(t).scrollLeft}function fe(t){let e=W(t),u=J(t),n=t.ownerDocument.body,i=y(e.scrollWidth,e.clientWidth,n.scrollWidth,n.clientWidth),r=y(e.scrollHeight,e.clientHeight,n.scrollHeight,n.clientHeight),o=-u.scrollLeft+Wt(t),s=-u.scrollTop;return w(n).direction==="rtl"&&(o+=y(e.clientWidth,n.clientWidth)-i),{width:i,height:r,x:o,y:s}}function Fe(t,e){let u=B(t),n=W(t),i=u.visualViewport,r=n.clientWidth,o=n.clientHeight,s=0,c=0;if(i){r=i.width,o=i.height;let l=rt();(!l||l&&e==="fixed")&&(s=i.offsetLeft,c=i.offsetTop)}return{width:r,height:o,x:s,y:c}}function de(t,e){let u=tt(t,!0,e==="fixed"),n=u.top+t.clientTop,i=u.left+t.clientLeft,r=v(t)?Y(t):L(1),o=t.clientWidth*r.x,s=t.clientHeight*r.y,c=i*r.x,l=n*r.y;return{width:o,height:s,x:c,y:l}}function Rt(t,e,u){let n;if(e==="viewport")n=Fe(t,u);else if(e==="document")n=fe(W(t));else if(R(e))n=de(e,u);else{let i=Pt(t);n={...e,x:e.x-i.x,y:e.y-i.y}}return P(n)}function Ht(t,e){let u=_(t);return u===e||!R(u)||G(u)?!1:w(u).position==="fixed"||Ht(u,e)}function me(t,e){let u=e.get(t);if(u)return u;let n=it(t,[],!1).filter(s=>R(s)&&M(s)!=="body"),i=null,r=w(t).position==="fixed",o=r?_(t):t;for(;R(o)&&!G(o);){let s=w(o),c=ot(o);!c&&s.position==="fixed"&&(i=null),(r?!c&&!i:!c&&s.position==="static"&&!!i&&["absolute","fixed"].includes(i.position)||k(o)&&!c&&Ht(t,o))?n=n.filter(D=>D!==o):i=s,o=_(o)}return e.set(t,n),n}function ge(t){let{element:e,boundary:u,rootBoundary:n,strategy:i}=t,o=[...u==="clippingAncestors"?me(e,this._c):[].concat(u),n],s=o[0],c=o.reduce((l,D)=>{let a=Rt(e,D,i);return l.top=y(a.top,l.top),l.right=j(a.right,l.right),l.bottom=j(a.bottom,l.bottom),l.left=y(a.left,l.left),l},Rt(e,s,i));return{width:c.right-c.left,height:c.bottom-c.top,x:c.left,y:c.top}}function Ae(t){let{width:e,height:u}=Lt(t);return{width:e,height:u}}function pe(t,e,u){let n=v(e),i=W(e),r=u==="fixed",o=tt(t,!0,r,e),s={scrollLeft:0,scrollTop:0},c=L(0);if(n||!n&&!r)if((M(e)!=="body"||k(i))&&(s=J(e)),n){let a=tt(e,!0,r,e);c.x=a.x+e.clientLeft,c.y=a.y+e.clientTop}else i&&(c.x=Wt(i));let l=o.left+s.scrollLeft-c.x,D=o.top+s.scrollTop-c.y;return{x:l,y:D,width:o.width,height:o.height}}function Ot(t,e){return!v(t)||w(t).position==="fixed"?null:e?e(t):t.offsetParent}function jt(t,e){let u=B(t);if(!v(t)||Mt(t))return u;let n=Ot(t,e);for(;n&&vt(n)&&w(n).position==="static";)n=Ot(n,e);return n&&(M(n)==="html"||M(n)==="body"&&w(n).position==="static"&&!ot(n))?u:n||bt(t)||u}var Ee=async function(t){let e=this.getOffsetParent||jt,u=this.getDimensions,n=await u(t.floating);return{reference:pe(t.reference,await e(t.floating),t.strategy),floating:{x:0,y:0,width:n.width,height:n.height}}};function he(t){return w(t).direction==="rtl"}var Ce={convertOffsetParentRelativeRectToViewportRelativeRect:De,getDocumentElement:W,getClippingRect:ge,getOffsetParent:jt,getElementRects:Ee,getClientRects:ae,getDimensions:Ae,getScale:Y,isElement:R,isRTL:he};var Nt=xt,$t=ht;var Ut=Bt;var Vt=(t,e,u)=>{let n=new Map,i={platform:Ce,...u},r={...i.platform,_c:n};return Et(t,e,{...i,platform:r})};var Xe=Object.hasOwnProperty;var kt=ee(zt(),1),Ge=(0,kt.default)();var It=(t,e,u)=>{let n=new URL(t.getAttribute(e),u);t.setAttribute(e,n.pathname+n.hash)};function Yt(t,e){t.querySelectorAll(\'[href^="./"], [href^="../"]\').forEach(u=>It(u,"href",e)),t.querySelectorAll(\'[src^="./"], [src^="../"]\').forEach(u=>It(u,"src",e))}var we=new DOMParser;async function Xt({clientX:t,clientY:e}){let u=this;if(u.dataset.noPopover==="true")return;async function n(d){let{x:g,y:m}=await Vt(u,d,{middleware:[Ut({x:t,y:e}),Nt(),$t()]});Object.assign(d.style,{left:`${g}px`,top:`${m}px`})}let i=()=>[...u.children].some(d=>d.classList.contains("popover"));if(i())return n(u.lastChild);let r=new URL(document.location.href);r.hash="",r.search="";let o=new URL(u.href),s=o.hash;o.hash="",o.search="";let c=await fetch(`${o}`).catch(d=>{console.error(d)});if(i()||!c)return;let[l]=c.headers.get("Content-Type").split(";"),[D,a]=l.split("/"),F=document.createElement("div");F.classList.add("popover");let f=document.createElement("div");switch(f.classList.add("popover-inner"),F.appendChild(f),f.dataset.contentType=l??void 0,D){case"image":let d=document.createElement("img");d.src=o.toString(),d.alt=o.pathname,f.appendChild(d);break;case"application":switch(a){case"pdf":let A=document.createElement("iframe");A.src=o.toString(),f.appendChild(A);break;default:break}break;default:let g=await c.text(),m=we.parseFromString(g,"text/html");Yt(m,o);let p=[...m.getElementsByClassName("popover-hint")];if(p.length===0)return;p.forEach(A=>f.appendChild(A))}if(n(F),u.appendChild(F),s!==""){let d=f.querySelector(s);d&&f.scroll({top:d.offsetTop-12,behavior:"instant"})}}document.addEventListener("nav",()=>{let t=[...document.getElementsByClassName("internal")];for(let e of t)e.addEventListener("mouseenter",Xt),window.addCleanup(()=>e.removeEventListener("mouseenter",Xt))});\n';var custom_default=`code[data-theme*=" "] {
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;import{Features,transform}from"lightningcss";import{transform as transpile}from"esbuild";function getComponentResources(ctx){let allComponents=new Set;for(let emitter of ctx.cfg.plugins.emitters){let components=emitter.getQuartzComponents(ctx);for(let component of components)allComponents.add(component)}let componentResources={css:new Set,beforeDOMLoaded:new Set,afterDOMLoaded:new Set};for(let component of allComponents){let{css,beforeDOMLoaded,afterDOMLoaded}=component;css&&componentResources.css.add(css),beforeDOMLoaded&&componentResources.beforeDOMLoaded.add(beforeDOMLoaded),afterDOMLoaded&&componentResources.afterDOMLoaded.add(afterDOMLoaded)}return{css:[...componentResources.css],beforeDOMLoaded:[...componentResources.beforeDOMLoaded],afterDOMLoaded:[...componentResources.afterDOMLoaded]}}__name(getComponentResources,"getComponentResources");async function joinScripts(scripts){let script=scripts.map(script2=>`(function () {${script2}})();`).join(`
`);return(await transpile(script,{minify:!0})).code}__name(joinScripts,"joinScripts");function addGlobalPageResources(ctx,componentResources){let cfg=ctx.cfg.configuration;if(cfg.enablePopovers&&(componentResources.afterDOMLoaded.push(popover_inline_default),componentResources.css.push(popover_default)),cfg.analytics?.provider==="google"){let tagId=cfg.analytics.tagId;componentResources.afterDOMLoaded.push(`
    ...
    `):cfg.analytics?.provider==="posthog"&&componentResources.afterDOMLoaded.push(`
